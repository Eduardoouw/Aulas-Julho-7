...
opacity.addEventListener('input', upadeFilters);
blur.addEventListener('input', upadeFilters);
grayscale.addEventListener('input', upadeFilters)
brightness.addEventListener('input', upadeFilters);
