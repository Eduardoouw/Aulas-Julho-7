...
toggleBtn.addEventListener('click', () => {
    ...
    if (toggled) {
        if (property.value === 'width') {
            ...
            // all or other, do a simple transform + color
            box.style.width = '200px'
            box.style.height = '200px'
            box.style.backgroundColor = 'mediumseagreen';
            box.style.transform = 'rotate(45deg)';
...
property.addEventListener('change', upadateTransition);
property.addEventListener('input', upadateTransition);
property.addEventListener('change', upadateTransition);