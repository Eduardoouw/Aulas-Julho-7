...
rotate.addEventListener('input', updadeTransform);
scale.addEventListener('input', updadeTransform);
translateX.addEventListener('input', updadeTransform);
translateY.addEventListener('input', updadeTransform);
